...
while running:
    ...
    if current_time - fruit_spawn_time >= fruit_lifespan:
        fruit_spawn = False
    if current_time - fruit2_spawn_time >= fruit_lifespan:
        fruit2_spawn = False
    ...
    show_score(1, green, 'times new roman', 60)
